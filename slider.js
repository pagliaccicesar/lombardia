    ...
    // --- Mantener siempre la vista en el inicio al cargar ---
    window.addEventListener("load", () => {
        // Asegurarse de que la ventana esté completamente cargada antes de desplazarse
        setTimeout(() => {
            // Comprueba si la URL es www.lombardia.com.ar
            if (window.location.hostname === "www.lombardia.com.ar") {
                window.scrollTo({ top: 0, left: 0, behavior: "instant" });
            }
        }, 100);
        document.activeElement?.blur(); // quita el foco de cualquier botón
    });
    ...
    class Slider {
        ...
        updateNavButtons() {
            this.navButtons.forEach((button, buttonIndex) => {
                ...
                // Eliminamos el focus para evitar que el navegador haga scroll automático
